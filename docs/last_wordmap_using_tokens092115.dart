...
========================
    ...
    'PEOPLE:body:external:parts:not:reproduction': [ //CAN TOUCH
                            ...
                            'SOFTAB:head',
                                ...
                                '#mouth',
                                    ...
                                    "*open_one's_mouth,hold_one's_mouth_open,gape-(to)", //Verb form
    ...
    'PEOPLE:early:childhood:' : [
                       ...
                       'SOFTAB:world:expanding',
                            '#friend',
                            "#social",
                            "#society",
                                "*habit,custom", //?? Weak assoc
    ...
    'PEOPLE:adult:elderly':  [
                            ...
                            "#stave,staff",  //??Strange symbol - horizontal lines
...
'PEOPLE:eat:food:natural': [     //GENERALLY FOODS THAT CAN BE GATHERED ON A FARM/IN NATURE  - not needing involved process
    ...
    'PEOPLE:other_people:communications': [
    ...
    'PEOPLE:ARE:career:professions':    [
                        'SOFTAB:professions',
                            ...
                            '#archeologist',
                            '#artist',
                                "*picture,image,icon,painting", //Redundant, want to get painting here
                            '#actor',
                            '#architect',
                            '#audiologist',
                            '#botanist',
    ...
    'PEOPLE:mind:feelings:attitude': [  //NOTE: Many of these could be (partially) "Paired" as opposites.. but benifit not clear
                         ...
                         "#passive",
                         "#passivity", //NOT BASIC, SEE PASSIVE
    ...
    'PEOPLE:mind:general:' : [
                            ...
                            '#energy_(mental)',
                            '#memory',
                            '#remember,recall-(to)',  //NOT BASIC

                            "#fantasy,phantasy,imagination,illusion",

                            '#brain_signal',

                            '#understand,see-(to)', //NOT BASIC
                            '#understanding,comprehension',

                            '#opinion',

                            '#want,desire',
                            '#want,desire-(to)',  //NOT BASIC
                            "#longing,yearning",
    ...
    'PEOPLE:disability':    [ //and otherwise enablement...
                            '#nonspeaking',
                            '#hearing-impaired',
                            '#hearing_impairment',
                            ...
                            "#little_person", //????? A disability??  It can be according to US law, but....
    ...
    'PEOPLE:use:transport': [
                        ...
                        'SOFTAB:city:street:',
                            "#manhole_cover", //very low frequency?  great symbol!

                        'SOFTAB:common:vehicles',
                            "#compartment", //?from symbol looks to be assoc with transport (train?)...
                            "#crew,staff",
                            "#station",
...
'SCENES:transport:water' :   [
    ...
    'SCENES:food:preparation': [   //rename 'prepare_food,cook-(to)' to 'preparation'
                        ...
                        'SOFTAB:table:setting:items',
                            ...
                            "#storage_jar,preserving_jar", //would not go on table, ??belongs with preservation items
                            '#bottle_opener',
                            '#cylinder,can',
                                "*lid",
                            '#potholder,oven_mitt',
...
//index
 ...
 'ANIMATE:animal_water': [
    ...
    'ANIMATE:animals:general':   [
                        "#place_to_feed,feeding_place,feeding_ground", //?? animals?
...
'LANGUAGE:many_question:groupings': [
                        '#nothing,none',
                        ...
                        '#very_much,very_many',
                        '#indefinite',
                        "#collection,pile,tussock_(etc)", //nice
                        '#count',
                        '#a,an,any',
                        '#fewer,less',
                        '#pair',
    ...
    'LANGUAGE:evaluate':    [
                        ...
                        "#should,would-(modal_aux_v)",  //??? GENERAL
    ...
    'LANGUAGE:KEYS':        [  //NOT INTENDED TO BE 'EXCLUSIVE' LOCATION, only perhaps incidentally, looking for 'fundamental' symbol here / C Bliss "Outline"
                        ...
                        "#making,production,fashioning",   //<<BASIC     SIMPLY A TRIANGLE..
    ...
    'LANGUAGE:logic':       [
                        ...
                        '#plan,design-(to)',
                        "#dichotomy,duality", //??   also artistic?



                        '#idea,thought', //GENERAL
                        '#hypothesis,theory', //GENERAL
                        "#dilemma", //??  not a bad place for this?
...
'#conjure,turn_to,transform-(to)',
                        ...
                        "#repeat,copy,duplicate,reproduce-(to)", //NOT BASIC
                        "#redo-(to)", //NOT BASIC
                        "#search-(to)",
                        "#send-(to)",
    ...
    'LANGUAGE:NULL:TEMP:TERMINATOR': [
        ...
        "#negative_dependency",   //??What is a negative dependency?  an independency?
        ...
        //THESE ARE THE VERY LAST ~50 WORDS AFTER OVER A WEEK OF CATEGORIZING
        "#ability_(half_sized)",
        "#active,actively",
