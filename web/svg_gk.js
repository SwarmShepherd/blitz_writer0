/* svg.js 1.0.1-41-gb8853bf - svg selector inventor polyfill regex default color array pointarray patharray number viewbox
 bbox rbox element parent container fx relative event defs group arrange mask clip gradient pattern doc shape symbol use
 rect ellipse line poly path image text textpath nested hyperlink marker sugar set data memory helpers - svgjs.com/license */

//THIS FILE LAST MODIFIED BY GK 06/03/15
;
(function (root, factory) {
        ...
        , extend: {
            ...
            update: function (o) {
                if (typeof o == 'number' || o instanceof SVG.Number) {
                    o = {offset: arguments[0], color: arguments[1], opacity: arguments[2]}
                };
    ...
    //===============================================================================================
    //=============================EXTENDING: Line, Polyline, Polygon, Path==========================
    //===============================================================================================
    ...
    SVG.SetFX = SVG.invent({
        // Initialize node - store reference to set
        create: function (set) {
            this.set = set;
        }
    });//END_OF_CLASS( SetFX );
    ...
    SVG.extend(SVG.Element, {
        ...
        data: function (a, v, r) {
            if (typeof a == 'object') {
                ...
                //GK REWRITE, BUT
                //var dta = (v === null) ? null : (r === true || typeof v === 'string' || typeof v === 'number') ? v : JSON.stringify(v);
                //this.attr('data-' + a, dta);
